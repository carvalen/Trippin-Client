      ...
      <div key="container" className="home-container">
        ...
        <div className="home-text">
          ...
          <p className="welcome-how">
            ...
            que podrás guardar en tu perfil y editarla o eliminarla. También
            podrás crear una lista nueva!
          </p>
        </div>
      </div>
        ...
        <div className="links-container">
          <Link to="/mar/days">
            <div className="container-image">
              <img alt="mar" src="./images/mar.jpg" />
              <div className="image-text">MAR</div>
            </div>
          </Link>
          <Link to="/rural/days">
            <div className="container-image">
              <img alt="rural" src="./images/rural.jpg" />
              <div className="image-text">RURAL</div>
            </div>
          </Link>
          <Link to="/camping/days">
            <div className="container-image">
              <img alt="camping" src="./images/camping.JPG" />
              <div className="image-text">CAMPING</div>
            </div>
          </Link>
          <Link to="/nieve/days">
            <div className="container-image">
              <img alt="mar" src="./images/nieve.jpg" />
              <div className="image-text">NIEVE</div>
            </div>
          </Link>
        </div>
      </div>
